...
Callbacks are optional — agents decide whether to report back based on whether the caller needs the result to continue. DM never accepts callbacks; dev calls back to dev-manager when the commit is ready.
